...
public class ValueTypeVisitor extends CtAbstractVisitor {
    ...
    public <T> void visitCtMethod(CtMethod<T> ctMethod) {
        ...
        if (returnsNullObjectType(ctMethod)) {
            ctMethod.accept(
                    new CollaboratorVisitor(
                            processorClass,
                            environment,
                            new CollaboratorBuilder(valueTypeBuilder.getFactory()),
                            valueTypeBuilder,
                            processorProperties));
            return;
        }
        ...
        addNonNullAnnotation(
                newMethod,
                valueTypeBuilder.getFactory()); // @NonNull Optional<Address> getAddress(){}
        ...
        ctMethod.getDeclaringType().addMethod(newMethod);
    }

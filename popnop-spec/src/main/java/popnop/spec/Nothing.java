...
public abstract class Nothing<T> implements Poptional<T> {

	private static final Nothing NOTHING = new NothingImpl();
	...
	@Override
	public <R extends NullObject> R map(Function<? super T, R> mapper, Supplier<R> ifEmpty) {
		return ifEmpty.get();
	}
	...
	public final String toString() {
		return "poptional.popnop.spec.Poptional.empty()";
	}
}
